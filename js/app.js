...
if (document.querySelector('.mainslider__dotts')) {
...
//проверка и определение пк или нет
if (isMobile.any()) {
	let menuParents = document.querySelectorAll('.sidebar__item-parent>a');
...
//Выезжалка
	let menuParents = document.querySelectorAll('.sidebar__item-parent');
...
//Burger выезжалки
let menuPageBurger = document.querySelector('.header-sidebar__burger');
let sidebarPageBody = document.querySelector('.sidebar__body');
menuPageBurger.addEventListener("click", function (e) {
	menuPageBurger.classList.toggle('_active');
	_slideToggle(sidebarPageBody);
});

//==========================================================================================================================================================================================================

let selectSearch = document.querySelector('.search-page__title');
let categoriesSearch = document.querySelector('.categories-search');

selectSearch.addEventListener('click', function (e) {
	selectSearch.classList.toggle('_active');
...
for (let index = 0; index < checkboxCategories.length; index++) {
	...
	checkboxCategory.addEventListener("change", function (e) {
		...
		if(checkboxActiveCategories.length > 0) {
			selectSearch.classList.add('_categories');
			let searchQuantity = selectSearch.querySelector('.search-page__quantity');
			searchQuantity.innerHTML = searchQuantity.getAttribute('data-text') + checkboxActiveCategories.length;
		} else {
			selectSearch.classList.remove('_categories');
		}
	});
}
